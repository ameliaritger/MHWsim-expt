...
**could do relative to starting number too  mutate(n_rel = n_true / first(n_true))**
...
Q is important but not super important to my Q (process error variance - every tank has different inherent variation, and there is justification for diagonal and equal bc no tank variation) - so stick with diagonal and equal Q. we want to not test variation at tank level, but with Z/C. 

U is inherent directional increase/decrease. Equal  
...
## Prep behavior data
**for other analyses I used percent_fully_open, so might want to switch to that ultimately**
