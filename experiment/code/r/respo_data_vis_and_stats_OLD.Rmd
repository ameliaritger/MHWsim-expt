...
p1 <- data_pred %>% 
  # filter(Genet == "A" | Genet == "B" | Genet == "E") %>% 
  mutate(Treatment = factor(Treatment, levels = c("ambient", "severe MHW", "extreme MHW")),
         Genet = factor(Genet, levels = c("A", "B", "C", "D", "E"))) %>%
  ...
  facet_wrap(Treatment~.,
             labeller =  labeller(Treatment = c("ambient" = "Ambient", "severe MHW" = "Severe MHW", "extreme MHW" = "Extreme MHW")))+
  ...
  scale_x_discrete(labels = c("MHW" = "MHW", "recovery" = "Recovery")) +
...
p1
ggsave(p1, filename = here("Figures", "amelia2.png"), height=6, width=10)
