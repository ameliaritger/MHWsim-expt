...
temp_sorted <- temp_clean %>%
  ...
  ungroup() %>%
  filter(timestamp > ymd_hms("2023-09-22 12:00:00")) #remove first 24 hours after addition of Corynactis because temperature fluctuations as I was messing around with heaters/chillers
