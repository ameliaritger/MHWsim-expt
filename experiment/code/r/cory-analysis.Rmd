...
y <- all_count$n_true %>%
  as.matrix()
X <- model.matrix(n_true ~ treatment + genet, data = all_count)
...
glarma_model_int <- glarma(y, x, phiLags = c(1), type = "Poi", method = "FS", residuals = "Pearson", maxit = 100, grad = 1e-6)

summary(glarma_model)
summary(glarma_model_int)
...
print(c(extractAIC(glarma_model_int), extractAIC(glarma_model_2), extractAIC(glarma_model_3), extractAIC(glarma_model_4), extractAIC(glarma_model_5), extractAIC(glarma_model_6), extractAIC(glarma_model_7)))
#lag 6 has lowest AIC, lag 5 has second lowest AIC
summary(glarma_model_int)
summary(glarma_model_6)

glarma_model_1_6 <- glarma(y, x, phiLags = c(1:6), type = "Poi", method = "FS", residuals = "Pearson", maxit = 100, grad = 1e-6)
print(c(extractAIC(glarma_model_int), extractAIC(glarma_model_6), extractAIC(glarma_model_1_6)))
summary(glarma_model_1_6)

thetaLags = c(1,2,5), type = "Poi", method = "FS",
                    residuals = "Pearson", maxit = 100, grad = 2.22e-16)
phiLags = c(1), type = "Poi", method = "FS",
                      residuals = "Pearson"
