...
model_1 <- glmmTMB(
  percentmin ~ treatment * genet * day_numeric + (1 | tank) + (1 | tank:genet) + ar1(day_factor + 0|treatment),
  data = all_behavior,
  family = beta_family(),
  weights = n
)
model_2 <- glmmTMB(
  percentmin ~ treatment * genet * day_numeric + (1 | tank) + (1 | tank:genet) + ar1(day_factor + 0|genet),
  data = all_behavior,
  family = beta_family(),
  weights = n
)
model_3 <- glmmTMB(
  percentmin ~ treatment * genet * day_numeric + (1 | tank) + (1 | tank:genet) + ar1(day_factor + 0|treatment+genet),
  data = all_behavior,
  family = beta_family(),
  weights = n
)
...
BIC_compare <- BIC(model_0, model_1, model_2, model_3, model_4, model_5)
...
all_simple <- all %>%
  ...
  mutate(mhw_week = interaction(all_simple$mhw, all_simple$week))
