...
fit1 <- MARSS(marss_date_wide, model=model_list1, method="BFGS")
tidy(fit1)
autoplot(fit1)
...
fit2 <- MARSS(marss_date_wide, model=model_list2, method="BFGS")
tidy(fit2)
autoplot(fit2)
...
fit3 <- MARSS(marss_date_wide, model=model_list3, method="BFGS")
tidy(fit3)
autoplot(fit3)
...
model.list1 <- list(B = B, U = U, Q = Q, Z = Z, A = A, D = D, 
    d = temp_covariate, x0 = x0)
kem1 <- MARSS(marss_date_wide, model = model.list1)
...
model.list2 <- list(B = B, U = U, Q = Q, Z = Z, A = A, R = R, 
    C = C, c = temp_covariate)
kem2 <- MARSS(marss_date_wide, model = model.list2)
...
kem3 <- MARSS(marss_date_wide, model = model.list3)
```
