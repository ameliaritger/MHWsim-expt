...
C_matrix <- matrix(factor(paste("tank", rep(1:15, each = 5), sep = "")), ncol = 1)
...
```{r}
mod_list <- list(
  B = "identity", #MAYBE diagonal and equal or diagonal and unequal
  U = "unequal",
  Q = "diagonal and equal", #MAYBE diagonal and unequal if tank mixing diff
  Z = "placeholder",
  A = "zero",
