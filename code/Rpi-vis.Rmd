...
```{r}
sump_all <- read_csv(here("data", "2023-09-13 16:23:34.257618.csv")) %>%
  select(1:7, 23:25) %>%
  clean_names() %>%
  mutate(timestamp = ymd_hms(timestamp)) %>%
  rename(severe =8,
...
sump_tank <- read_csv(here("data", "2023-09-13 16:23:34.257618.csv")) %>%
  ...
  filter(timestamp > ymd_hms("2023-09-13  23:00:00"))

ggplot(sump_tank, aes(x=timestamp)) +
  geom_line(aes(y=temperature-19.5, color=sensor), size=1) +
  geom_point(aes(y=sump-19.5, color=severe_heater), size=0.5) +
  scale_colour_manual(values=c("on"="red", "off"="blue")) +
  geom_line(aes(y=severe_set-19.5), color="black") +
