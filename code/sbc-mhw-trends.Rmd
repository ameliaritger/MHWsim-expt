...
<<<<<<< HEAD
         thresh3=seas+8) %>%
  filter(t>ymd("2014-08-01") & t<ymd("2015-03-01"))
=======
         thresh3=seas+8,
         extreme=temp+4,
         chill=temp-4) %>%
  filter(t>=ymd("2015-07-01") & t<ymd("2016-02-01"))
>>>>>>> c0fb1217eca06d6ef5cf99b2bfbc92f460aa9507
...
<<<<<<< HEAD
#ggsave(here("figures", "MHWsim_profile.png"), width = 15, height = 7)
=======
...
mhw_subset_comb <- left_join(mhw_subset_avg, mhw_subset, by="t") %>%
  group_by(t) %>%
  mutate_at(vars(temp.y,chill.y,extreme.y), funs(replace(., duplicated(.), NA)))
